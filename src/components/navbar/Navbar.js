        ...
        <>
            <div className='fixed top-0 left-0 w-full py-2 px-[2rem] md:px-[3rem] 2xl:px-[7rem]'>
                <div className='flex justify-between items-center'>
                    <p className='text-[#a9e0c5] font-semibold duration-150 text-[22px] font-[Poppins] select-none cursor-pointer hover:text-gray-400'>Axel</p>
                    <div>
                        <i className='bi bi-translate duration-300 text-[20px] text-gray-300 mr-8 hover:text-[#7feeb6] hover:cursor-pointer'/>
            ...
            <nav className='flex justify-center items-center'>
                <div className='fixed w-[70%] py-5 px-8 bottom-4 backdrop-blur-sm bg-[#152c53]/50 rounded-full md:w-[35%] 2xl:w-[20%]'>
