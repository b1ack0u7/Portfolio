                    ...
                    <div className="NB--home">
                      <div className="NB--home__sub">
                          ...
                          <div className="NB--home__translate">
                            <svg width="35px" height="30px" viewBox="0 0 50 47" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <nav>
                        <Link to="/home">
                          <div className="NB--navigation__items">
                              <svg width="30px" height="30px" viewBox="0 0 31 27" fill="none" xmlns="http://www.w3.org/2000/svg">
